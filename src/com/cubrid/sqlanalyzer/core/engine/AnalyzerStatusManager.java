...
import com.cubrid.cubridmigration.core.engine.DataMigrationStatus;

public class AnalyzerStatusManager {
    ...
    private final Map<String, AnalyzeStatus> dataMigrationStatus =
            new HashMap<String, AnalyzeStatus>();
    ...
    public void addExpCount(String owner, String source, long count) {
        synchronized (lockObj) {
            ...
            AnalyzeStatus dms = dataMigrationStatus.get(src);
            if (dms == null) {
                dms = new AnalyzeStatus();
                dms.setSource(src);
